...
HD_PWD='D:/Project/Vivado/PYNQ/MIX/MIX.runs/design_1_DropSample_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_DropSample_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_DropSample_1_0.tcl
